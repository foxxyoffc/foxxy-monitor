...
import { BadgeCheck, BarChart3, Bell, Calculator, Coffee, LayoutDashboard, LogOut, Menu, MessageSquareText, Phone, Settings, ShieldCheck, UsersRound, X } from "lucide-react";
